...
class ExampleAlarmQuickTestsScreen extends StatefulWidget {
  const ExampleAlarmQuickTestsScreen({super.key});

  @override
  State<ExampleAlarmQuickTestsScreen> createState() =>
      _ExampleAlarmQuickTestsScreenState();
}

class _ExampleAlarmQuickTestsScreenState
    extends State<ExampleAlarmQuickTestsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Single id quick tests')),
      body: SafeArea(
        child: Center(
          child: Column(
