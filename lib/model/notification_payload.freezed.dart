...
abstract class $NotificationPayloadCopyWith<$Res> {
  ...
  @useResult
  $Res call({NotificationType type, int? alarmId});
}
...
class _$_NotificationPayload extends _NotificationPayload {
  _$_NotificationPayload({required this.type, this.alarmId}) : super._();
  ...
  @override
  String toString() {
    return 'NotificationPayload(type: $type, alarmId: $alarmId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, type, alarmId);
...
abstract class _NotificationPayload extends NotificationPayload {
  factory _NotificationPayload(
      ...
      final int? alarmId}) = _$_NotificationPayload;
  _NotificationPayload._() : super._();
