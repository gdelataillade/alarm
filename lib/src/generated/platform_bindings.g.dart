...
class AlarmSettingsWire {
  ...
  bool operator ==(Object other) {
    ...
    return id == other.id &&
        ...
        volumeSettings == other.volumeSettings &&
        ...
        allowAlarmOverlap == other.allowAlarmOverlap &&
        iOSBackgroundAudio == other.iOSBackgroundAudio;
  }
...
class VolumeSettingsWire {
  ...
  bool operator ==(Object other) {
    ...
    return volume == other.volume &&
        fadeDurationMillis == other.fadeDurationMillis &&
        _deepEquals(fadeSteps, other.fadeSteps) &&
        volumeEnforced == other.volumeEnforced;
  }
...
class VolumeFadeStepWire {
  ...
  bool operator ==(Object other) {
    ...
    return timeMillis == other.timeMillis && volume == other.volume;
  }
...
class NotificationSettingsWire {
  ...
  bool operator ==(Object other) {
    ...
    return title == other.title &&
        ...
        icon == other.icon &&
        iconColorAlpha == other.iconColorAlpha &&
        iconColorRed == other.iconColorRed &&
        iconColorGreen == other.iconColorGreen &&
        iconColorBlue == other.iconColorBlue;
  }
